  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await loginVendor(email, password ) // Use the login method from AuthContext
        ...
        setUser(response.user)  // Assuming response contains the user data
        localStorage.setItem('urbanhive_user', JSON.stringify(response.user))


        // navigate('/vendor/home') // Redirect to the vendor's home page after successful login
